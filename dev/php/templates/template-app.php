		...
		<div class="Content Content--app" id="post-<?php the_ID(); ?>">
			<div class="u-gridContainer">
				...
				<article class="Content-article u-gridCol8" id="post-<?php the_ID(); ?>">
					...
					<a href="https://play.google.com/store/apps/details?id=com.wDierenkliniekWinkelhof" target="_blank" class="google-play"><img src="<?php echo get_stylesheet_directory_uri(); ?>/img/play.png"/></a>
